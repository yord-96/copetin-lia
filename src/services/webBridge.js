...
const createWebBridge = () => ({
  ...
  personnel: createPersonnelOperations({ transaction, readQueryState, makeId, deepClone, consumeDocumentCode }),
  ...
  contracts: {
    ...
    update: async (payload) => {
      ...
      transaction((state) => {
        ...
        if (contract.pickupTimeMode !== 'coordinate') assertSameDayTimeWindow(contract.pickupWindowStart, contract.pickupWindowEnd, 'La ventana de recojo');
